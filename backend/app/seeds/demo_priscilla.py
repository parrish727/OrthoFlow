...
async def enrich_priscilla(db) -> None:
    ...
    events = [
        ...
        (today - timedelta(days=60),  "payment",    "Monthly auto-pay — card DECLINED (insufficient funds)", _d(0), None, "card", "AUTOPAY-06"),
        (today - timedelta(days=58),  "payment",    "Monthly auto-pay — card on file (retry succeeded)", _d(-275), None, "card", "AUTOPAY-06R"),
