...
from app.api.routes import portal, portal_admin, patient_messages, reports, migration, invisalign, consultant_reports
...
from app.api.routes import ortho_ops
...
app.include_router(ortho_ops.router, tags=["ortho-ops"])
