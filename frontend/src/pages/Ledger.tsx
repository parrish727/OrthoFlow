...
import { BookOpen, Search, Plus, DollarSign, ChevronDown, Users, LayoutDashboard, Receipt, BarChart3, Settings, User, LogOut, CalendarDays, CreditCard, Shield, FileText, Banknote } from 'lucide-react'
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Patient Ledger</p>
            </div>
          </div>
